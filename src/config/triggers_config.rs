...
mod tests {
    ...
    fn test_trigger_from_timer_config() {
        ...
        assert_eq!(trigger.trigger, TriggerType::Periodic { interval: Duration::from_secs(30) });
    ...
    fn test_trigger_type_equality() {
        ...
        assert_eq!(
            TriggerType::Periodic { interval: Duration::from_secs(30) },
            TriggerType::Periodic { interval: Duration::from_secs(30) }
        );
        assert_ne!(TriggerType::OnStart, TriggerType::Periodic { interval: Duration::from_secs(30) });
    }
}
